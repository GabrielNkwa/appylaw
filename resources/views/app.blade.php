                                ...
                                <div>
                                    ...
                                    <ul class="category-menu">
                                        @foreach(categories() as $category)
                                            <li class="cat-item"><a href="{{ route('store') }}?search={{ $category->unique_id }}">{{ $category->name }}</a></li>
                                        @endforeach
                                    </ul>
                                </div>
                            </nav>
                            ...
                            <div class="main-navigation flex-lg-right">
                                <div class="cart-widget">
                                    <div class="login-block">
                                        @if(!user())
                                        <a href="{{ route('auth') }}" class="font-weight-bold">Login or Register</a> <br>
                                        @else
                                            <a onclick="return confirm('are you sure you want to logout?')" href="{{ route('logout') }}" class="font-weight-bold text-danger"><i class="fas fa-power-off"></i> Logout</a>
                                        @endif
                                    </div>
                                    <a href="{{ route('cart') }}">
                                        <div class="cart-block">
                                            <div class="cart-total">
                                                <span class="text-number" id="cart-count">
                                                    0
                                                </span>
